            ...
            {isMenu && (
              ...
              >
                {user && user.email === "jitendrasingh14355@gmail.com" && (
                  <Link to={"/createItem"}>
                    <p className="px-4 py-2 flex items-center gap-3 cursor-pointer hover: bg-green-200 transition-all duration-100 ease-in-out
                        text-textColor text-textbase text-base"
                        onClick={()=> {setIsMenu(false)}}>
                      New Item <MdAdd />
                    </p>
                  </Link>
          ...
          {isMenu && (
            ...
            >
              <ul className="flex flex-col px-4 py-2">
                <Link to={'/'} className="text-base text-textColor hover:font-extrabold duration-100 transition-all ease-in-out cursor-pointer py-2"
                onClick={() => {setIsMenu(false)}}>
                  Home
                </Link>
                <li className="text-base text-textColor hover:font-extrabold duration-100 transition-all ease-in-out cursor-pointer py-2"
                onClick={() => {setIsMenu(false)}}>
                  Menu
                </li>
                <li className="text-base text-textColor hover:font-extrabold duration-100 transition-all ease-in-out cursor-pointer py-2"
              ...
              {user && user.email === "jitendrasingh14355@gmail.com" && (
                <Link to={"/createItem"}>
                  <p className="px-4 py-3 flex items-center gap-3 cursor-pointer hover: bg-green-200 transition-all duration-100 ease-in-out text-textColor text-textbase text-base font-semibold"
                  onClick={() => {setIsMenu(false)}}>
                    New Item <MdAdd />
                  </p>
                </Link>
