...
const CartContainer = () => {
  ...
  return (
    <motion.div
      ...
      className="fixed top-0 right-0 w-full md:w-375 h-screen bg-cartItem rounded-xl drop-shadow-md flex flex-col z-[101]"
    >
      ...
      {cartItems && cartItems.length > 0 ? (
          ...
          <div className="w-full flex-1 bg-cartTotal rounded-t-[2rem] flex flex-col items-center justify-evenly px-8">
            ...
            {user ? (
              <motion.button
                whileTap={{ scale: 0.8 }}
                type="button"
                className="w-full p-2 rounded-full bg-gradient-to-tr from-green-700 to-green-400 text-gray-50 text-lg my-2 hover:shadow-lg"
              >
                Check Out
              </motion.button>
            ) : (
        ...
        <div className="w-full h-full flex flex-col items-center justify-center gap-6">
          <img className="w-300" src={EmptyCart} alt="img" />
